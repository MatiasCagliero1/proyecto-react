...
function Carrusel() {
    return (
        <div className="uk-position-relative uk-visible-toggle uk-light" tabIndex="-1" uk-slideshow="true" autoplay-interval="3000">
            <ul className="uk-slideshow-items fotoscarrusel">
            <li><img className="img-carru" src="/img/Franjas/alex_rider.jpg" alt=""/></li>
            <li><img className="img-carru" src="/img/Franjas/PactoFuga" alt=""/></li>
